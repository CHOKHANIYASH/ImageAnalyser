...
export default function Home() {
  ...
  return (
    ...
    <CardContainer className="inter-var ml-5 flex flex-col gap-4 w-1/2 h-2/3 ">
      ...
      <CardBody className="relative group/card rounded-xl gap-4 w-full flex flex-col md:flex-row justify-center items-center">
           <a href="/tags" className="px-4 py-2 mt-4 text-sm font-bold text-white bg-black rounded-xl" type='submit'> 
              Image tags
           </a>
           <a href="/caption" className="px-4 py-2 mt-4 text-sm font-bold text-white bg-black rounded-xl" type='submit'> 
              Image caption
           </a>
      </CardBody>
    </CardContainer>
